...
client/var/global/list/modes = list(   	ModeItem("Extended Role-Play", "Extended Role-Play", "extended"),
										...
										ModeItem("Section 13", "\black Section 13", "centcom"),
										...
										ModeItem("Monkey (Devo Virus)", "Monkey", "monkey"),
										ModeItem("Zombie Apocalypse", "\red Zombie Nights", "zombie"),
										...
										ModeItem("Random (No Announcement)", "Secret", "secret"),
										ModeItem("Rand (Announcement)", "Random", "random")	)
