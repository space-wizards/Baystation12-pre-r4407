...
/proc/call_shuttle_proc(var/mob/user)
	...
	world << "\blue <B>Alert: The emergency shuttle has been called. It will arrive in [ticker.timeleft/60] minutes.</B>"
	shuttlecomming = 1
	ticker.timing = 1
	return

/proc/enable_supply_shuttle(var/mob/user)
	for(var/obj/machinery/computer/supply_shuttle/SS in world)
		SS.allowedtocall = !(SS.allowedtocall)
