/datum/game_mode/traitor
	...
	var/const/waittime_l = 99999999999999 //lower bound on time before intercept arrives (in tenths of seconds)
	var/const/waittime_h = 99999999999999 //upper bound on time before intercept arrives (in tenths of seconds)
...
/datum/game_mode/traitor/check_win()
	...
	if (traitorwin)
		...
		ticker.killer.unlock_medal("Mission Complete", 1, "Successfully win a round as traitor.", "hard")
	else
