...
<li>Monkey Pen now has automatic air regulators, so they don't suffocate on their own CO2, hopefully.</li>
<li>Rearranged the SE corner of the station, and shrank/moved the S. security station as a result.</li>
<li>Minor changes to a couple areas.</li>
...
<P><B>Trorbes' Changes (Sunday, 3nd January, 2010)</B></P>
<li>FINALLY fixed the Plasma Lab power situation.  Promise.</li>
<li>Slightly modified engine room design and added inlets to the engine.</li>
<li>Removed the Captain's revolver and the SWAT gear, due to misuse of the equipment.</li>

<P><B>Trorbes' Changes (Saturday, 2nd January, 2010)</B></P>
<li>Lots of bug fixes.  There are probably plenty still to find, so let me know if you find any more.</li>
<li>Added a couple small spare tools storage rooms in the main halls.</li>
<li>Expanded Toxins.  Now has siphons and an external testing chamber for larger bombs.</li>
<li>Rearranged Atmos a bit so that it's more accessable.</li>
<li>Added the Cabinet and Folders for the lawyer.  The cabinet is currently a glorified closet, however.</li>
<li>Toned down the Firefighter's assess rights drastically.</li>

<P><B>Trorbes' Changes (Monday, 28th December, 2009)</B></P>
<li>New Map!  Almost everything has been remapped; some things (like the maze) have been left alone for now.  <B>THIS IS THE TESTING PHASE!  Please note that not everything is as it should be; please report any errors, bugs, or suggestions to Trorbes on the forum</B></li>
<li>Area code cleaned up.  This won't be noticable in the game, but it makes things much easier for mappers.
<li>Job Renaming: Genetic Researcher is now Geneticist, Barman is now Bartender, Toxin Researcher is now Plasma Researcher.</li>
<li>Job Changes: Toxin Officer was removed due to being redundant.  Lawyer was added.
<li>Known issue: APCs may or may not produce and/or use power for the moment; this is for debugging purposes.
<li>Caveat: Saved character profiles have been deleted due to the above job changes.

<P><B>Engeneering made easy</B><BR>
<li>The engine now comes equipped with 6 large vats of plasma and oxygen</li>
<li>Wrench em and they will start venting gas into the engine</li>
<li>After they empty, just remove them using a welder.</li>

<P><B>More Changes!</B><BR>
<li>More Engine changes! As well as some other map changes!</li>
<li>Alot of other stuff. Solar panels are buildable, Solar computers are buildable, stuff like that.</li>

<P><B>Uristqwerty/Phoebos/CIB/Trorbes' Changes</B><BR>
<li>Engine changes!</li>
<li>Other stuff you probably don't care about!</li>

<P><B>CIB's Changes</B><BR>
<li>Escape Pods go to CentCom now!</li>
<li>Pill Canisters with Fever Remedy</li>
<li>Zombie modifications, e.g. breaking down walls!(Requires teamwork of zombies.)</li>


<P><B>Many Changes</B><BR>
<li>Space Zombies! OoOoOo! You're safe NOWHERE now!</li>
<li>Some Icon changes!</li>
<li>Admin Stuff!</li>
<li>The Supply Shuttle works, now!</li>
<li>Thanks to everyone who did all they did. Qwertyuiop, CIB, and Kholaus!</li>

<P><B>CIB's Changes</B><BR>
<li>Fixed Atmos Bugs(for good, hopefully)</li>
<li>Added Viruses(only Fever so far)</li>
<li>Some Mapping Changes to Genetics</li>
<li>Pod Locks that can be toggled from the Bridge</li>


<P><B>CIB's Changes</B><BR>
<li>Radiation Tweaks(radiation fades, affects you when you don't move, etc.)</li>
<li>Removed those dumb sprinklers</li>
<li>Removed CentCom messages</li>
<li>Genetics randomization and Less Efficient Revival</li>
<li>Air exchange optimization, reduces lag GREATLY when there are no hull breaches(can't believe noone ever thought of that!)</li>
<li>Escape Pods! Woo!</li>

<P><B>Floirt's Changes (Tuesday, 14th July, 2009)</B><BR>
<li>Update of doom!</li>
<li>New, totally revamped Toxins (now with 100% more awesome)!</li>
<li>Buildable airlocks thanks to Qwertyuiopas!</li>
<li>A fuckton of tweaks, minor gameplay changes and bugfixes I was too lazy to track!</li>
<li>Basically, over 40 hours of work!</li>
<li>(And now I can focus on silly things like backstory and HFS.)</li>

<P><B>Floirt's Changes (Thursday, 25th June, 2009)</B><BR>
<li>AWESOME PROX SENSOR AND LASER FIX THANKS TO VULPES. YOU ARE AWESOME.</li>

<P><B>Floirt's Changes (Tuesday, 23rd June, 2009)</B><BR>
<li>Unsuccesful attempt at fixing lasers and prox sensors. Help?</li>
<li>Re-enabled pod code, which was de-activated for some reason.</li>
<li>More bar redesigning, now it isn't as ugly and encumbered as it was.</li>

<P><B>Floirt's Changes (Sunday, 21st June, 2009)</B><BR>
<li>Stashed a second cryo cell in medbay.</li>

<P><B>Floirt's Changes (Saturday, 20th June, 2009)</B><BR>
<li>Fully functionnal autolathe in engineering. Damn, this thing was hard to make.</li>
<li>MOAR HANDCUFFS. I just added some where they usually spawn.</li>
<li>Heads spawn with tasers instead of lasers. No more pesky inventory management for you!</li>
<li>Nerf of the radiation random event. Or so I hope.</li>
<li>General debugging stuff I don't quite remember. Also, failure at fixing the supply shuttle. =(</li>

<P><B>Floirt's Changes (Saturday, 13th June, 2009)</B><BR>
<li>Moved the captain's quarters where Senior Staff was.</li>
<li>Removed the whole greenhouse thing, instead added some artificial earth near the bar.</li>
<li>Moved the "EVA security" on another Z-Level until it isn't redundant.</li>
<li>Removed the create explosion button for admins.</li>
<li>More supplies in the supply shuttle.</li>
<li>Pretty chara-setup area.</li>

<P><B>Ryu's Modification (Wednesday June, 2009)</B><BR>
<li>Fire Station Enlarged.</li>
<li>Supply Shuttle Added.</li>
<li>Admins can now change random event percentage.</li>

<P><B>Ryu's Modification (Thursday June 11, 2009)</B><BR>
<li>Head of Security and Fire Fighter jobs added.</li>
<li>Fire Station, EVA Security, and Artificial Earth now added to the station.</li>

<P><B>Modified Saturday 25th April, 2009</B><BR>
<li>Radiation now works with turfs, so entering an irradiated area will give you radiation over time.</li>
<li>Added an advanced medical scanner to the medbay. You put a person in, and it tells info on all of their internal organs.</li>
<li>Space beer gives you slight amounts of liver damage. Continued liver damage can cause liver failure which causes poisoning over time.</li>

<P><B>Modified Monday 20th April, 2009</B><BR>
<li>Radiation now works with turfs, so entering an irradiated area will give you radiation over time.</li>

<P><B>Modified Sunday 19th April, 2009</B><BR>
<li>Turrets no longer pop up if they are disabled.</li>
<li>Generic hit sounds actually work.</li>
<li>Sounds are less laggy and easier to implement now.</li>

<P><B>Modified Saturday 18th April, 2009</B><BR>
<li>The most complex incendiary grenade now does 50% more damage compared to the original 100% extra damage.</li>
<li>Fixed it so fire sprinklers would actually turn off when a fire alarm stops, when a lockdown is turned off, or if there is no area power.</li>
</p>
<P><B>Modified Wednesday 14th April, 2009</B><BR>
<li>JOBBANS BREAK</li>
</p>
<P><B>Modified Monday 13th April, 2009</B><BR>
<li>Wet floor tiles now have a slight blue tint. However occasionally the water turns into piss so be warned.</li>
<li>Added an achievement to revolutionary mode.</li>
<li>DNA Machine should work properly now.</li>
<li>Added a yellow towel to the janitor so he can dry floor tiles.</li>
<li>Changed admin titles around slightly.</li>
</p>
<HR>
<P><B>Modified Thursday 10th April, 2009</B><BR>
<li>Beer now has magical properties, like reducing your radiation by a small amount.</li>
</p>
<HR>
<P><B>Modified Monday 5th April, 2009</B><BR>
<li>Made the canes harder to get to so people would stop raiding the medbay for a cane.</li>
<li>Fixed a bug where you could scream if someone hit a broken body part and you were dead.</li>
<li>Added generic hit sounds for all weapons. Unless the weapon has a specific hit sound, the weapon will use a generic hit sound.</li>
</p>
<HR>
<P><B>Modified Sunday 4th April, 2009</B><BR>
<li>Added monocles for barmen.</li>
<li>Breaking someones arm or hand will make it impossible to pick something up in that hand until it is healed.</li>
<li>Fixed a <b>hugely</b> annoying bug where you would always decided you dont need that thing in your hand</li>
<li>Broken limbs no longer heal themselves over time, but medical gel is now 2x as effective at healing them.</li>
<li>Having a broken leg causes a much larger slowdown than it did before.</li>
<li>Breaking an arm causes you to be unable to pick up items in that hand.</li>
</p>
<HR>
<P><B>Modified Saturday 4th April, 2009</B><BR>
<li>Hulks can now open firelocks by applying fist directly to the firedoor.</li>
<li>Fixed the bug where the AI lockdown would cause fire sprinklers to remain on until they are destroyed.</li>
<li>All broken limbs heal very slowly but applying a liquid bandage will speed the healing rate by 3x.</li>
<li>Breaking your legs or feet slows you down drastically.</li>
<li>Having damage to your legs or feet now slows you down.</li>
<li>Holding a cane negates slowing by leg damage or having broken legs.</li>
<li>Added even more sound to some objects.</li>
</p>
<HR>
<P><B>Modified Friday 3rd April, 2009</B><BR>
<li>Added some music to centcom and a few other areas.</li>
<li>Audioraped the music before they killed everyone with the download time.</li>
<li>Added sound to a couple of objects.</li>
</p>
<HR>
<P><B>Modified Sunday 29th March, 2009</B><BR>
<li>Fixed a typo on the changelog.</li>
<li>Fixed a bug where sprinklers would megalag the server if they went off.</li>
<li>Give the medarmor a shiny golden-orange color just so you know to toolbox the guy even more.</li>
</p>
<HR>
<P><B>Modified Friday 27th March, 2009</B><BR>
<li>Fixed the bugfix from an older update that prevented admins from properly banning, again.</li>
</p>
<HR>
<P><B>Modified Tuesday 24th March, 2009</B><BR>
<li><b>Linked achievements with your savefile and fixed a few bugs so it works right</b></li>
<li>Added chloroform as another way to grief other players.</li>
<li>(hopefully)Fixed a bug that prevented admins from properly banning people.</li>
</p>
<HR>
<P><B>Modified Sunday 22th March, 2009</B><BR>
<li>Added descriptions to achievements so you know why the fuck you got it.</li>
<li>Added the flamethrower back in.</li>
</p>
<HR>
<P><B>Modified Saturday 21th March, 2009</B><BR>
<li>Added back in achievements, a log of every achievement is kept on the host to prevent redundant achievements.</li>
<li>Blood that has splattered onto walls can now be cleaned up just like regular blood.</li>
<li>Using a health analyzer, you can scan the DNA on walls and blood. Cleaning the surface removes the DNA.</li>
</p>
<HR>
<P><B>Modified Thursday 19th March, 2009</B><BR>
<li>Blood now can splatter onto walls if it was emitted close enough to the wall.</li>
<li>Blood on walls cant be cleaned up yet, will fix in next update.</li>
</p>
<HR>
<P><B>Modified Wednesday 18th March, 2009</B><BR>
<li>The test water sprinklers can be disabled and enabled with wirecutters.</li>
<li>Added a really overpowered piece of armor to the game, refill it with rejuv and antitoxin bottles.</li>
</ul>
</p>
<HR>
<P><B>Modified Tuesday 17th March, 2009</B><BR>
<li>Fixed a typo in Restructuring. E before I except after C, bitches.</li>
<li>Added water spinklers. Depending on how effective they are they will most likely be nerfed or removed.</li>
</ul>
</p>
<HR>
<P><B>Modified Monday 16th March, 2009</B><BR>
<li>Made it harder for admins to accidentally ban the traitor.</li>
<li>Fixed the admin panel so it doesn't look like a piece of shit.</li>
</ul>
</p>
<HR>
<P><B>Modified Saturday 14th March, 2009</B><BR>
<li>Removed flamethrower temporarily.</li>
